...
map("n", "<leader>e", vim.cmd.Oil, { desc = "Open Oil buffer" })
map("n", "<leader>ll", vim.cmd.Lazy, { desc = "Open Lazy UI" })
map("n", "<leader>lm", vim.cmd.Mason, { desc = "Open Mason UI" })
...
map("n", "m", "s", { desc = "Alt for delete and goto insert" })
map("n", "'", "/", { desc = "Alt for forward search" })
